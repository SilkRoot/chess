...
class Board():
    ...
    def importFEN(self,fenString):
        ...
        for element in fenParts[0]:
            #print(f"current BoardIndex: {boardIndex}")
            if element == '/':
                pass
                ...
                #print(f"Found piece is a {color} {element}")
                boardIndex += 1
        #print(f"Imported Board: {self.b}")
        return self.b
    ...
    def generateDenseBoard(self):
        ...
        for element in self.b:
            ...
            index += 1
        #print(F"Dense Board: {self.dense_b}")
        return(self.dense_b)
